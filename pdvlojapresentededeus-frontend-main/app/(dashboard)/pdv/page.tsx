    ...
    <div className="flex flex-col h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-y-auto md:overflow-hidden">
        ...
        <div className="w-full md:w-[40%] lg:w-[40%] xl:w-[38%] max-w-[560px] md:min-w-[420px] md:shrink-0 bg-surface border-t md:border-t-0 md:border-l border-border flex flex-col shadow-sm">
          ...
          <div className="h-[190px] md:h-[210px] md:shrink-0 overflow-y-auto px-5 md:px-6 py-5 receipt-dashed">
            {carrinho.length === 0 ? (
          ...
          <div className="border-t border-border px-5 md:px-6 py-4 space-y-3 overflow-y-auto">
            <div>
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full pl-3 pr-8 py-2.5 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition text-base disabled:opacity-50"
                  />
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="0,00"
                    disabled={carrinho.length === 0}
                    className="w-full pl-8 pr-3 py-2.5 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition text-base disabled:opacity-50"
                  />
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {pagamentos.map((pagamento, index) => (
                    <div key={index} className="flex gap-2 items-center">
                      <select
                        ...
                        className="flex-1 min-w-0 px-3 py-2.5 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
                      >
                        {FORMAS.map((forma) => (
                      ...
                      <div className="relative w-28">
                        ...
                        <input
                          ...
                          placeholder="0,00"
                          className="w-full pl-8 pr-2 py-2.5 rounded-xl border border-border bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
                        />
                      </div>
                      <button
                        type="button"
                  ...
                  {pagamentos.length < 4 && (
                    <button
                      ...
                      className="w-full border-2 border-dashed border-border rounded-xl py-2.5 text-sm font-semibold text-muted hover:border-primary hover:text-primary transition"
                    >
                      + Adicionar outra forma
                    </button>
                  )}
                  <div className="flex items-center justify-between rounded-xl bg-primary-light/50 border border-primary/10 px-4 py-2.5 text-sm">
            ...
            {!pagamentoMultiplo && formaPagamento === "DINHEIRO" && (
              <div>
                ...
                <input
                  ...
                  placeholder="0,00"
                  disabled={carrinho.length === 0}
                  className="w-full px-3 py-2.5 rounded-xl border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition text-base disabled:opacity-50"
                />
              </div>
            )}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white font-bold text-lg py-3 rounded-xl transition shadow-sm disabled:opacity-50"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 bg-danger-light hover:bg-danger/20 text-danger font-bold text-base py-3 rounded-xl transition disabled:opacity-50"
            >
              Cancelar venda
            </button>
          </div>
